...
<!-- 头部logo -->
				...
				<div id="main">
					...
					<div id="introd">
						<div class="bookspace">
							...
							<div class="bookfont">
								<font class="bookname">沉默巡游</font>
								<br />
								<font color="red">&nbsp;一桩众目睽睽下的凶杀案，华丽的多重反转，出人意料的神展开！</font>
							</div>
							...
							<div>
								<table border="0" cellspacing="" cellpadding="" style="padding-left: 20px;">
									<tr height="50px">
										...
										<td width="300px" style="color: gray;text-decoration: line-through;">￥29.9</td>
									</tr>
									<tr height="50px">
										<td>优惠价：</td>
										<td style="color: red; font-size: 25px;">￥19.9</td>
									</tr>
									<tr height="50px">
										<td>作&nbsp;&nbsp;&nbsp;者：</td>
										<td>东野圭吾</td>
							...
							<form action="tushu1_suc.jsp" method="post">
							<div class="buy">
								<font>购买数量:</font>
								<font id="sub" >-</font>
		...
		<!-- 浮动窗口 -->
		<div id="float">
			<button class="btn" onclick="window.location.href ='gouwuche.html'">购物车</button>
			<button class="btn">我的</button>
			<button class="btn">在线客服</button>
			<span></span>
		</div>
</body>
