...
<!-- 头部logo -->
		<div id="header">
			<div class="head"> 
				...
				<div class="login">
					<font>欢迎<%=request.getSession().getAttribute("sessionname") %>登陆成功！</font>
				</div>
			</div>
		...
		<div id="banner">
			<div class="ban">
				<div class="kind">
					...
					<div class="other">
						<a href="#" class="nav"><b>影像</b></a>
						<a href="#" class="nav"><b>百科</b></a>
						<a href="#" class="nav"><b>电子书</b></a>
					</div>
					<div class="other">
						<a href="#" class="more"><b>全部商品分类>></b></a>
					</div>
				</div>

				<div class="lunbotu" id="banlbt">
					<!-- 存放轮播图区域 -->
					<div class="box" >
						<img src="img/img1.png" id="bannerpic">
					</div>
					<!-- 存放banner图小点点区域 -->
					<ul>
						<li id="li1"></li>
						<li class="on" id="li2"></li>
						<li class="on" id="li3"></li>
						<li class="on" id="li4"></li>
						<li class="on" id="li5"></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="good">
					...
					<div class="goodbook">
						<a href="tushu2.jsp">
							...
							<font class="font1">轻松诙谐诉说人生道理</font>
							<br />
							<font class="font2">￥21.8</font>
							<font class="font3">￥32.8</font>
						</a>
					</div>
					<div class="goodbook">
						<a href="#">
		...
		<!-- 底部灰色-->
		<div id="base">
			<div class="mg" >Conpyright@ 2020-2011 DEDE58 yyssd</div>
		</div>
		<!-- 底部黑色-->
		<div id="bottom">
			<div class = "con">
...
<!-- banner图的js文件 -->
	...
	<script src="js/home_hot.js" type="text/javascript" charset="utf-8"></script>
</html>