...
<%
	try {
		...
		//增添参数
		String img = "img/book3.jpg";
		String bookname= "沉默巡游";
		String bookprice = "19.8";
		...
		out.print("<script type='text/javascript'>alert('购买成功！');window.location.href='tushu1.jsp'</script>");
