					...
					<div class="right">
						<div class="rtop">订单管理</div>	
							<div class="r2">
								...
								<div class="r2long">
									<div class="r2name" style="border-top: 2px solid red;">订单编号</div>
									<div class="r2name">书籍名称</div>
									<div class="r2name">用户昵称</div>
									<div class="r2name">书籍数量</div>
									<div class="r2name">书籍单价</div>
									<div class="r2name">书籍总价</div>
								</div>
								<div  class="roller" >
									<!-- 存放书籍信息区 -->
									<table >
										...
										try {
											...
											ResultSet rs =stmt.executeQuery("select *from db_order ");
											...
											while(rs.next()){
												...
												String ordermoney = rs.getString("order_money");
												/* String sql_del="delete from db_order where user_id= '"+userid+"'";
