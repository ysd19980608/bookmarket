...
<meta charset="UTF-8">
<title>修改个人信息</title>
<link rel="stylesheet" type="text/css" href="css/geren_xiugai.css"/>
</head>
<body>
<!-- 头部logo -->
		<div id="header">
		...
		<div id="mainer">
			<div id="main">
				...
				<!-- 右侧区域 -->
				<form action="gerenxiugai_suc.jsp" method="post">
				<div class="right">
					<div class="rtop">个人资料</div>
					<div class="r1">
						<div class="rimg"><img src="img/2weima.jpg" /></div>
						<div class="rwelcom">
							<font>欢迎您，<%=request.getSession().getAttribute("sessionname") %></font>
						</div>
						<div>
							<font>会员级别:<a href="#">普通会员</a></font>
						</div>
						<div>
							<font>联系方式: <input type="text" name="usertel" id="usertel" placeholder="<%=request.getSession().getAttribute("sessiontel") %>" /></font>
						</div>
						<div>
							<font>地&nbsp;&nbsp;&nbsp;&nbsp;址:&nbsp;&nbsp;&nbsp; <input type="text" name="useradd" id="useradd"  placeholder="<%=request.getSession().getAttribute("sessionadd") %>" /></font>
						</div>
						<input class ="sure" type = "submit" value = "确认修改" ></input>
					</div>
				</div>
			</div>
		</div>
